...
struct sgpu_debug {
	...
	bool gfx_jobtimeout_to_panic;
	bool comp_jobtimeout_to_panic;

#ifdef CONFIG_DEBUG_FS
	struct dentry			*debugfs_gfx_jobtimeout_to_panic;
	struct dentry			*debugfs_comp_jobtimeout_to_panic;
...
#define sgpu_jobtimeout_to_panic_check(adev, ring_type) (0)
#endif
