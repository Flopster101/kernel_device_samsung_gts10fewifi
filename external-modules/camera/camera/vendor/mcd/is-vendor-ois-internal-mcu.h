...
enum is_ois_power_mode {
	...
	OIS_POWER_MODE_DUAL,
	OIS_POWER_MODE_WIDE_TELE,
	OIS_POWER_MODE_WIDE_TELE2,
	OIS_POWER_MODE_TELE_TELE2,
	OIS_POWER_MODE_TRIPLE,
	OIS_POWER_MODE_SKIP,
	OIS_POWER_MODE_END
};

static const char *const ois_pw_mode_str[OIS_POWER_MODE_END] = {
	[OIS_POWER_MODE_NONE] = "OIS_PW_NONE",
	[OIS_POWER_MODE_UW] = "OIS_PW_UW",
	[OIS_POWER_MODE_SINGLE_WIDE] = "OIS_PW_W",
	[OIS_POWER_MODE_SINGLE_TELE] = "OIS_PW_T",
	[OIS_POWER_MODE_SINGLE_TELE2] = "OIS_PW_T2",
	[OIS_POWER_MODE_DUAL] = "OIS_PW_DUAL",
	[OIS_POWER_MODE_WIDE_TELE] = "OIS_PW_W_T",
	[OIS_POWER_MODE_WIDE_TELE2] = "OIS_PW_W_T2",
	[OIS_POWER_MODE_TELE_TELE2] = "OIS_PW_T_T2",
	[OIS_POWER_MODE_TRIPLE] = "OIS_PW_TRIPLE",
	[OIS_POWER_MODE_SKIP] = "OIS_PW_SKIP"
};

#define OIS_PW_STR(x) (((ARRAY_SIZE(ois_pw_mode_str)) > (x)) ? ois_pw_mode_str[(x)] : "UNKNOWN")
