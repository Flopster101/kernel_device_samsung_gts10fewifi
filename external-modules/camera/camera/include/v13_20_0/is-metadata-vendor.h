...
enum is_subscenario_id {
	...
	ISS_SUB_SCENARIO_SUPER_STEADY_FHD_VIDEO = 105,             /* Super Steady FHD 30fps / 60fps */
	ISS_SUB_SCENARIO_SUPER_STEADY_QHD_VIDEO = 106,             /* Super Steady QHD 30fps / 60fps */
	ISS_SUB_SCENARIO_SUPER_STEADY_FHD_HDR10_VIDEO = 125,       /* HDR10+ Supersteady FHD 30fps / 60fps */
	ISS_SUB_SCENARIO_SUPER_STEADY_QHD_HDR10_VIDEO = 126,       /* HDR10+ Supersteady QHD 30fps / 60fps */
	ISS_SUB_SCENARIO_SUPER_STEADY_FHD_HLG10_VIDEO = 145,       /* HLG10 Supersteady FHD 30fps / 60fps */
	ISS_SUB_SCENARIO_SUPER_STEADY_QHD_HLG10_VIDEO = 146,       /* HLG10 Supersteady QHD 30fps / 60fps */
	ISS_SUB_SCENARIO_SUPER_STEADY_FHD_LOG10_VIDEO = 165,       /* LOG10 Supersteady FHD 30fps / 60fps */
	ISS_SUB_SCENARIO_SUPER_STEADY_QHD_LOG10_VIDEO = 166,       /* LOG10 Supersteady QHD 30fps / 60fps */
	ISS_SUB_END,
};
...
enum node_recursive_nr_type {
	...
	NODE_RECURSIVE_NR_FORCE_2ITER = 3,
};
...
enum aa_capture_intent {
	...
	AA_CAPTURE_INTENT_STILL_CAPTURE_MID_HIGHRES                             = 179,
	AA_CAPTURE_INTENT_STILL_CAPTURE_MID_HIGHRES_NN                          = 180,
	AA_CAPTURE_INTENT_STILL_CAPTURE_MID_HIGHRES_NN_AEB                      = 181,
	AA_CAPTURE_INTENT_STILL_CAPTURE_MID_HIGHRES_OIS                         = 182,
	AA_CAPTURE_INTENT_STILL_CAPTURE_MID_HIGHRES_LOW_LIGHT                   = 183,
...
enum aa_remosaicCropZoomRatio_mask
{
	AA_REMOSAIC_CROP_ZOOM_PATTERN    = 0x03 << 0, /* bit 0 ~ 1, RGB(0), TETRA(1) */
	AA_REMOSAIC_CROP_ZOOM_ZOOM_VALUE = 0xFF << 2, /* bit 2 ~ 9 */
};
...
enum aa_sensor_result_state
{
	AA_SENSOR_STATE_RESULT_NORMAL = 0,
	AA_SENSOR_STATE_RESULT_CROPPED_REMOSAIC_RGB = 1,
	AA_SENSOR_STATE_RESULT_CROPPED_REMOSAIC_TETRA = 2,
};

enum aa_sensor_available_state
{
	AA_SENSOR_STATE_AVAILABLE_NORMAL = 0,
	AA_SENSOR_STATE_AVAILABLE_CROPPED_REMOSAIC = 1,
};
...
struct camera2_aa_dm {
	...
	enum aa_sensor_result_state	vendor_sensorResultState;
	enum aa_sensor_available_state	vendor_sensorAvailableState;
...
struct camera2_uctl {
	...
	float				zoomRatio;
	enum camera_flash_mode		flashMenuMode;
	...
	struct camera2_object_detect_uctl multiObjectDetectInfoUd[15];
...
struct camera2_udm {
	struct camera2_colorcorrection_dm color; // For SW ISP Capture
