...
static void is_scaler_set_cinfifo_ctrl(void __iomem *base_addr)
{
	...
	is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_YUV_CINFIFO_CONFIG],
		&mcsc_fields[MCSC_F_YUV_CINFIFO_STALL_BEFORE_FRAME_START_EN], 0x1);
	is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_YUV_CINFIFO_CONFIG],
		&mcsc_fields[MCSC_F_YUV_CINFIFO_DEBUG_EN], 0x1);
}
