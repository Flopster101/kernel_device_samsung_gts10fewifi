...
enum sec_ts_irq_state {
	SEC_INPUT_IRQ_ENABLE = 0,
	SEC_INPUT_IRQ_DISABLE = 1,
	SEC_INPUT_IRQ_DISABLE_NOSYNC = 2,
};
...
struct sec_ts_plat_data {
	...
	const char *firmware_name_mp;	/* for novatek ic */
	...
	bool support_touchscreen_lid_switch;
	int dev_extra_event_buffer;
