...
#if IS_ENABLED(CONFIG_KEYBOARD_STM32_POGO_USE_VOTING)
...
/* for booster */
#define KBD_MAX77816B_STATUS				0x01
#define KBD_MAX77816B_CONFIG1				0x02
#define KBD_MAX77816B_CONFIG2				0x03
#define KBD_MAX77816B_VOLTAGE				0x04
...
struct stm32_dev {
	...
	u32 keyboard_model;
	u32 model_type;
	struct stm32_model_info *model_info;
