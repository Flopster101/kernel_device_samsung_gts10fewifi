...
struct nvt_ts_mem_map {
	...
	uint32_t MMAP_MP_HISTORY_EVENT;
...
static const struct nvt_ts_mem_map NT36536_single_memory_map = {
	...
	/* BLD CRC */
	.BLD_LENGTH_ADDR          = 0x1FB518,	//0x1FB518 ~ 0x1FB51A (3 bytes) ok
	.ILM_LENGTH_ADDR          = 0x1FCC34,	//0x1FCC34 ~ 0x1FCC36 (3 bytes) ok
	.DLM_LENGTH_ADDR          = 0x1FCC44,	//0x1FCC44 ~ 0x1FCC46 (3 bytes) ok
	.BLD_DES_ADDR             = 0x1FB514,	//0x1FB514 ~ 0x1FB516 (3 bytes) ok
	.ILM_DES_ADDR             = 0x1FCC30,	//0x1FCC30 ~ 0x1FCC32 (3 bytes) ok
	.DLM_DES_ADDR             = 0x1FCC40,	//0x1FCC40 ~ 0x1FCC42 (3 bytes) ok
	.G_ILM_CHECKSUM_ADDR      = 0x1FCC38,   //0x1FCC38 ~ 0x1FCC3B (4 bytes) ok
	.G_DLM_CHECKSUM_ADDR      = 0x1FCC48,	//0x1FCC48 ~ 0x1FCC4B (4 bytes) ok
	.R_ILM_CHECKSUM_ADDR      = 0x1FCC7C,	//0x1FCC7C ~ 0x1FCC7F (4 bytes) ok
	.R_DLM_CHECKSUM_ADDR      = 0x1FCC80,	//0x1FCC80 ~ 0x1FCC83 (4 bytes) ok
	.DMA_CRC_EN_ADDR          = 0x1FB51B,	//ok
	.BLD_ILM_DLM_CRC_ADDR     = 0x1FB532,	//ok. TODO:2bytes
	.DMA_CRC_FLAG_ADDR        = 0x1FB534,	//ok
	//SRAM Test
	.MBT_MUX_CTL0			= 0x1FBD00,
	.MBT_MUX_CTL1			= 0x1FBD01,
	.MBT_MUX_CTL2			= 0x1FBD02,
	.MBT_DB				= 0x1FBD03,
	.MBT_MODE			= 0x1FBD07,
	.MBT_EN				= 0x1FBD08,
	.MBT_OP				= 0x1FBD09,
	.MBT_STATUS			= 0x1FBD0E,
	.LPWG_DUMP_ADDR			= 0x130F81,
};
...
static const struct nvt_ts_mem_map NT36532_cascade_memory_map = {
	...
	//Cascade SPI DMA
	.SPI_DMA_LENGTH			= 0x1FC920,
	.SPI_DMA_REM_ADDR		= 0x1FC91C,
	.SPI_DMA_LOC_ADDR		= 0x1FC918,
	.SPI_DMA_TX_RESET		= 0x1FC900,
	.SPI_DMA_RX_RESET		= 0x1FC980,
	.LOC_RW_BUF_ADDR		= 0x1229E0,
	.SPI_TX_CMD			= 0x1FC924,
	//SRAM Test
	.MBT_MUX_CTL0			= 0x1FBD00,
	.MBT_MUX_CTL1			= 0x1FBD01,
...
static const struct nvt_ts_trim_id_table trim_id_table[] = {
	{.id = {0x14, 0xFF, 0xFF, 0x23, 0x65, 0x03}, .mask = {1, 0, 0, 1, 1, 1},
		.mmap = &NT36536_single_memory_map, .hwinfo = &NT36536_hw_info},
	{.id = {0x15, 0x0E, 0xFF, 0x23, 0x65, 0x03}, .mask = {1, 1, 0, 1, 1, 1},
		.mmap = &NT36536_single_memory_map, .hwinfo = &NT36536_hw_info},
	{.id = {0x15, 0xFF, 0xFF, 0x23, 0x65, 0x03}, .mask = {1, 0, 0, 1, 1, 1},
		.mmap = &NT36536_single_memory_map, .hwinfo = &NT36536_hw_info},
	{.id = {0xFF, 0xFF, 0xFF, 0x32, 0x65, 0x03}, .mask = {0, 0, 0, 1, 1, 1},
		.mmap = &NT36532_single_memory_map, .mmap_casc = &NT36532_cascade_memory_map,
