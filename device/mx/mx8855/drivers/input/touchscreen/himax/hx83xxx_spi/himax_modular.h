...
extern bool _hx83123_init(void);
#endif
...
static int (*kp_himax_cable_detect_func)(struct device *dev, bool on);
#endif
...
#ifdef HX_USB_DETECT_GLOBAL
extern int himax_cable_detect_func(struct device *dev, bool on);
#endif
