...
#if !(IS_ENABLED(CONFIG_TOUCHSCREEN_HIMAX_IC_HX83102) || IS_ENABLED(CONFIG_TOUCHSCREEN_HIMAX_IC_HX83122) || IS_ENABLED(CONFIG_TOUCHSCREEN_HIMAX_IC_HX83123))
...
#define HX_83123A_SERIES_PWON		"HX83123A"
...
#define HX_DIAG_EVENTSTACK_DIFF 0x01
#define HX_DIAG_SRAM_DIFF 0x09
...
/******* SPI-end *******/
	...
	struct regulator *regulator[HIMAX_TS_REGULATOR_MAX];
	int regulator_count;
