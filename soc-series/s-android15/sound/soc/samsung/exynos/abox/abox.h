...
enum abox_dai {
	...
	ABOX_NSRC12, /* Virtual DAI */
	ABOX_NSRC13, /* Virtual DAI */
	ABOX_NSRC14, /* Virtual DAI */
	ABOX_NSRC15, /* Virtual DAI */
...
struct abox_data {
	...
	unsigned int pmu_aud_mask[OFFSET_MASK];
	unsigned int pmu_aud_gresetn_cpu[OFFSET_MASK];
	unsigned int pmu_aud_cnt_en_wdt[OFFSET_MASK];
	unsigned int pmu_pad_ret[OFFSET_MASK];
	unsigned int pmu_silent_rst[OFFSET_MASK];
	unsigned int sys_acp_con[OFFSET_MASK];
	unsigned int sys_qch_bypass[OFFSET_MASK];
