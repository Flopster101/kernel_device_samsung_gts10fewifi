...
#define USB_AUDIO_PAGE_SIZE	4096
#define USB_AUDIO_MEM_BASE	0xC0000000

#define USB_AUDIO_SAVE_RESTORE	(USB_AUDIO_MEM_BASE)
#define USB_AUDIO_DEV_CTX	(USB_AUDIO_SAVE_RESTORE+USB_AUDIO_PAGE_SIZE)
#define USB_AUDIO_INPUT_CTX	(USB_AUDIO_DEV_CTX+USB_AUDIO_PAGE_SIZE)
#define USB_AUDIO_OUT_DEQ	(USB_AUDIO_INPUT_CTX+USB_AUDIO_PAGE_SIZE)
#define USB_AUDIO_IN_DEQ	(USB_AUDIO_OUT_DEQ+USB_AUDIO_PAGE_SIZE)
#define USB_AUDIO_FBOUT_DEQ	(USB_AUDIO_IN_DEQ+USB_AUDIO_PAGE_SIZE)
#define USB_AUDIO_FBIN_DEQ	(USB_AUDIO_FBOUT_DEQ+USB_AUDIO_PAGE_SIZE)
#define USB_AUDIO_ERST		(USB_AUDIO_FBIN_DEQ+USB_AUDIO_PAGE_SIZE)
#define USB_AUDIO_DESC		(USB_AUDIO_ERST+USB_AUDIO_PAGE_SIZE)
...
#define USB_URAM_SIZE		SZ_1K * 24
#elif defined(CONFIG_SOC_S5E9955)
#define USB_AUDIO_XHCI_BASE     0x18A10000
#define USB_URAM_BASE           0x18A00000
#define USB_URAM_SIZE           SZ_1K * 24
#define EXYNOS_URAM_ABOX_EMPTY_ADDR	0x18A03D00
#define EMPTY_SIZE			128
#else
#define USB_AUDIO_XHCI_BASE     0x13200000
#define USB_URAM_BASE           0x13300000
...
struct exynos_usb_audio {
	...
	atomic_t unmap_all_done;
	u32 usb_audio_state;

	struct snd_kcontrol *kctl;
	struct snd_kcontrol *kctl1;
	struct snd_kcontrol *kctl2;
	u32 user_scenario;
	u32 low_power_call;
	int pcm_index;
