...
extern ktime_t esca_time_calc_u16(u16 start, u16 end);
extern ktime_t esca_time_calc_s32(u32 start, u32 end);
...
static inline ktime_t esca_time_calc_u16(u16 start, u16 end)
{
	return 0;
}

static inline ktime_t esca_time_calc_s32(u16 start, u16 end)
{
	return 0;
}
...
#if IS_ENABLED(CONFIG_EXYNOS_ESCA) || IS_ENABLED(CONFIG_EXYNOS_FLEXPMU_DBG)
...
extern void exynos_flexpmu_dbg_show_lcd_status(void);
extern void exynos_flexpmu_dbg_clr_lcd_status(void);
#if IS_ENABLED(CONFIG_ESCA_SLEEP_PROFILER)
extern void exynos_flexpmu_dbg_sleep_latency(void);
#endif
#else
