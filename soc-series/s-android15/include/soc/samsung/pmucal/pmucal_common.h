...
enum pmucal_seq_acctype {
	...
	PMUCAL_WRITE_EVT11,
	PMUCAL_GPUSRAMHOLD,
	PMUCAL_SET_BIT_ATOMIC_SUB,
	PMUCAL_CLR_BIT_ATOMIC_SUB,
	PMUCAL_COND_SET_BIT_ATOMIC,
	PMUCAL_COND_CLR_BIT_ATOMIC,
	PMUCAL_COND_SET_BIT_ATOMIC_SUB,
	PMUCAL_COND_CLR_BIT_ATOMIC_SUB,
	PMUCAL_WAIT_RETRY,
	PMUCAL_DFS_REQ,
	PMUCAL_CHECK_AND_GO,
	PMUCAL_WRITE_WLOCK,
