...
struct tzasc_fail_info {
	...
	unsigned int tzasc_fail_region_num;
	unsigned int tzasc_fail_region2_attr;
	unsigned int tzasc_fail_region3_attr;
	unsigned long tzasc_fail_region_start;
	unsigned long tzasc_fail_region_end;
	unsigned long tzasc_fail_region2_start;
	unsigned long tzasc_fail_region2_end;
	unsigned long tzasc_fail_region3_start;
	unsigned long tzasc_fail_region3_end;
};
