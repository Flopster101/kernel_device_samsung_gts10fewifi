...
#define exynos_pm_qos_update_request(args...) ((void)0)
#define exynos_pm_qos_remove_request(args...) ((void)0)
#define cal_dfs_get_lv_num(args...)			(1)
#define cal_dfs_get_rate_asv_table(args...) ((void)0)
#define kcalloc(args...)			(0)
