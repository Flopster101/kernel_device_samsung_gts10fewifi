...
#define console_printf(args...)			(0)
#define initialize_spinlock(args...)	(0)
...
int (*fp_platform_load_pmu_fw_flags)(struct scsc_mif_abs *interface, u32 *ka_patch, size_t ka_patch_len, u32 flags) = &platform_load_pmu_fw_flags;
...
int (*fp_platform_mif_set_chip_id)(struct platform_mif *platform) = &platform_mif_set_chip_id;

static int platform_mif_set_ka_patch(struct platform_mif *platform, uint32_t *ka_patch_addr, uint32_t *ka_patch_addr_end);
int (*fp_platform_mif_set_ka_patch)(struct platform_mif *platform, uint32_t *ka_patch_addr, uint32_t *ka_patch_addr_end) = &platform_mif_set_ka_patch;

static int platform_mif_set_cfg_done(struct platform_mif *platform);
int (*fp_platform_mif_set_cfg_done)(struct platform_mif *platform) = &platform_mif_set_cfg_done;

static int platform_mif_set_cfg_ack(struct platform_mif *platform);
int (*fp_platform_mif_set_cfg_ack)(struct platform_mif *platform) = &platform_mif_set_cfg_ack;
