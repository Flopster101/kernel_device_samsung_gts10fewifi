...
static struct ufs_cal_save_and_restore_cfg hcs_dp_enable[] = {
	...
	{HCI_VENDOR_SPEC,	0x1150, 0, 	0x3, 0, RESTORE_ONLY, WRITE_ONLY, 		BRD_ALL, 0x0},
	{HCI_VENDOR_SPEC,	0x1150, 0, 	0x0, 0, RESTORE_ONLY, READ_MASK_BIT, 	BRD_ALL, 0x3},
	{HCI_STANDARD,		0x0034, 0, 	0x1, 0, RESTORE_ONLY, WRITE_ONLY, 		BRD_ALL, 0x0},
	{HCI_STANDARD,		0x0034, 0, 	0x1, 0, RESTORE_ONLY, READ_MASK_BIT, 	BRD_ALL, 0x1},
	...
	{HCI_STANDARD,		0x0020, 0,  0x0, 		0, RESTORE_ONLY, OVERRIDE_SFR_SET, 	BRD_ALL, 0x400},

	{HCI_STANDARD,		0x0030, 0, 	0x1, 0, RESTORE_ONLY, READ_MASK_BIT, 	BRD_ALL, 0x1},
	{HCI_VENDOR_SPEC,	0x1170, 0, 	0x1, 0, RESTORE_ONLY, WRITE_ONLY, 		BRD_ALL, 0x0},
...
static struct ufs_cal_save_and_restore_cfg unipro_wa_enable[] = {
	/* mib(just to monitor), sfr offset, value, .. */
	{UNIPRO,		0x7820, 	0,	0x01,	 	0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0x0},
	{UNIPRO,			 0, 	0,	0x01, 		0, RESTORE_ONLY, DELAY_TIME, BRD_ALL, 0x0},
	{UNIPRO,		0x7b00, 	0,	0x20, 		0, RESTORE_ONLY, READ_MASK_BIT, BRD_ALL, 0x20},
	{UNIPRO,		0x7830, 	0,	0x01, 		0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0x0},
	{UNIPRO,		0x7b00, 	0,	0xFFFFFFFF, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0x0},
...
static struct ufs_cal_save_and_restore_cfg unipro_resume_hibern[] = {
	...
	{UNIPRO, 0x3864, 0, 0x1,		0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL,	0x0},
...
static struct ufs_cal_save_and_restore_cfg save_pcs_sfr[] = {
	...
	{M_PHY_PCS_CMN, 0x013C, 0, 2, 0, SAVE_AND_RESTORE, WRITE_ONLY, BRD_ALL,	0},
	...
	{M_PHY_PCS_CMN, 0x0CA8, 0, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL,	0},

	{M_PHY_PCS_CMN, 0x013C, 0, 0, 0, SAVE_AND_RESTORE, WRITE_ONLY, BRD_ALL,	0},

	// pcs tx
	{M_PHY_PCS_TRSV, 0x413c, 0, 3, 3, SAVE_AND_RESTORE, WRITE_ONLY, BRD_ALL,	0},
	...
	{M_PHY_PCS_TRSV, 0x413c, 0, 0, 0, SAVE_AND_RESTORE, WRITE_ONLY, BRD_ALL,	0},

	// pcs rx
	{M_PHY_PCS_TRSV, 0x813C, 0, 3, 3, SAVE_AND_RESTORE, WRITE_ONLY, BRD_ALL,	0},
	...
	{M_PHY_PCS_TRSV, 0x813C, 0, 0, 0, SAVE_AND_RESTORE, WRITE_ONLY, BRD_ALL,	0},
...
static struct ufs_cal_save_and_restore_cfg save_pma_sfr_evt0[] = {
	...
	{M_PHY_PMA_TRSV, 0x10E0, 0x10E0, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x10F4, 0x10F4, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1BC0, 0x1BC0, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL, 0},
	/*OTP HEDGE SFR group E*/

	/* Vendor CAL code Group S*/
	{M_PHY_PMA_TRSV, 0x1054, 0x1054, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1144, 0x1144, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL, 0},
	/* Vendor CAL code Group E*/
	...
	{M_PHY_PMA_TRSV, 0x10E4, 0x10E4, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x10E8, 0x10E8, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x10EC, 0x10EC, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x10F0, 0x10F0, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x10F8, 0x10F8, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x10FC, 0x10FC, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1100, 0x1100, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1104, 0x1104, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1BC4, 0x1BC4, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1BC8, 0x1BC8, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1BCC, 0x1BCC, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1BD0, 0x1BD0, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL, 0},

	/* WRITE_SFR_OC_CODE
	 * cfg->value1(0x00 ~ 0x07) : should be same with backup_pma_oc_code_for_snr[] index
	 */
	{M_PHY_PMA_TRSV, 0x1F18, 0x1394, 0x00, 0, RESTORE_ONLY, WRITE_SFR_OC_CODE, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1F1C, 0x134C, 0x01, 0, RESTORE_ONLY, WRITE_SFR_OC_CODE, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1F24, 0x146C, 0x02, 0, RESTORE_ONLY, WRITE_SFR_OC_CODE, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1F30, 0x1484, 0x03, 0, RESTORE_ONLY, WRITE_SFR_OC_CODE, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1F20, 0x1494, 0x04, 0, RESTORE_ONLY, WRITE_SFR_OC_CODE, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1F2C, 0x149C, 0x05, 0, RESTORE_ONLY, WRITE_SFR_OC_CODE, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1F28, 0x14B4, 0x06, 0, RESTORE_ONLY, WRITE_SFR_OC_CODE, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1F34, 0x14C4, 0x07, 0, RESTORE_ONLY, WRITE_SFR_OC_CODE, BRD_ALL, 0},

	//OTP
	{M_PHY_PMA_CMN, 0xE3FC, 0x021C, 0, 0, RESTORE_ONLY, PMA_AFC_OTP_CODE, BRD_ALL, 0},
	...
	{M_PHY_PMA_CMN, 0x0048, 0x0048, 0x00, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x0230, 0x0230, 0xEF, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x0274, 0x0274, 0x77, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x02A4, 0x02A4, 0x03, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x031C, 0x031C, 0x00, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x0450, 0x0450, 0xA0, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x0454, 0x0454, 0x78, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x0838, 0x0838, 0x44, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x0844, 0x0844, 0x44, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x0300, 0x0300, 0x21, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},

	{M_PHY_PMA_TRSV, 0x14E4, 0x14E4, 0x11, 0x11, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1B38, 0x1B38, 0x11, 0x11, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x030C, 0x030C, 0x31, 0x31, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x0A38, 0x0A38, 0x11, 0x11, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x0A44, 0x0A44, 0x00, 0x00, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x0A50, 0x0A50, 0x11, 0x11, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x0A5C, 0x0A5C, 0x11, 0x11, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1004, 0x1004, 0x13, 0x13, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	...
	{M_PHY_PMA_TRSV, 0x12BC, 0x12BC, 0x01, 0x01, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1334, 0x1334, 0x55, 0x55, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1340, 0x1340, 0x44, 0x44, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1344, 0x1344, 0x03, 0x03, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1354, 0x1354, 0x55, 0x55, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1360, 0x1360, 0x33, 0x33, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1364, 0x1364, 0x00, 0x00, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x137C, 0x137C, 0x55, 0x55, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1380, 0x1380, 0x04, 0x04, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1388, 0x1388, 0x44, 0x44, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x138C, 0x138C, 0x01, 0x01, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x139C, 0x139C, 0x55, 0x55, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x13AC, 0x13AC, 0x00, 0x00, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x13DC, 0x13DC, 0x46, 0x46, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x13E4, 0x13E4, 0x06, 0x06, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x13EC, 0x13EC, 0x33, 0x33, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x13F0, 0x13F0, 0x05, 0x05, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x13FC, 0x13FC, 0x00, 0x00, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x150C, 0x150C, 0x01, 0x01, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1B40, 0x1B40, 0x3F, 0x3F, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1B4C, 0x1B4C, 0x60, 0x60, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1554, 0x1554, 0x55, 0x55, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1558, 0x1558, 0x44, 0x44, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x155C, 0x155C, 0x02, 0x02, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1560, 0x1560, 0x11, 0x11, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1564, 0x1564, 0x44, 0x44, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1568, 0x1568, 0x05, 0x05, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1570, 0x1570, 0x11, 0x11, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x15EC, 0x15EC, 0x44, 0x44, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1604, 0x1604, 0x44, 0x44, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x160C, 0x160C, 0x11, 0x11, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1610, 0x1610, 0x11, 0x11, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1780, 0x1780, 0x10, 0x10, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x13C8, 0x13C8, 0x0F, 0x0F, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x13D0, 0x13D0, 0x7F, 0x7F, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x17B8, 0x17B8, 0x01, 0x01, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1B20, 0x1B20, 0x00, 0x00, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1B24, 0x1B24, 0x00, 0x00, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1B50, 0x1B50, 0x03, 0x03, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1BB4, 0x1BB4, 0xE0, 0xE0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	...
	{M_PHY_PMA_CMN, 0xE3FE, 0x021C, 0x31, 0, RESTORE_ONLY, PMA_AFC_OTP_CHECK, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0xE3FE, 0x0220, 0x08, 0, RESTORE_ONLY, PMA_AFC_OTP_CHECK, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0xE3FE, 0x0224, 0x0B, 0, RESTORE_ONLY, PMA_AFC_OTP_CHECK, BRD_ALL, 0},
	...
	{M_PHY_PMA_TRSV, 0x1390, 0x1390, 0x01, 0x01, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1348, 0x1348, 0x01, 0x01, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1468, 0x1468, 0x01, 0x01, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1480, 0x1480, 0x01, 0x01, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1490, 0x1490, 0x01, 0x01, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1498, 0x1498, 0x01, 0x01, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x14B0, 0x14B0, 0x01, 0x01, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x14C0, 0x14C0, 0x01, 0x01, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1800, 0x1800, 0x00, 0x00, RESTORE_ONLY, OVERRIDE_SFR_CLEAR, BRD_ALL, 0x10},
...
static struct ufs_cal_save_and_restore_cfg save_pma_evt0_overwrite[][6] = {
	{{M_PHY_PMA_TRSV, 0x1054, 0x1054, 0x02, 0x02, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1144, 0x1144, 0x02, 0x02, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1370, 0x1370, 0x00, 0x00, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x13D0, 0x13D0, 0xFF, 0xFF, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x13D4, 0x13D4, 0xFF, 0xFF, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{0, 0, 0, 0, 0, 0, CFG_NONE, BRD_ALL, 0}}
};
...
static struct ufs_cal_save_and_restore_cfg save_pma_evt1_overwrite[][6] = {
	{{M_PHY_PMA_TRSV, 0x1054, 0x1054, 0x02, 0x02, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1144, 0x1144, 0x02, 0x02, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x1370, 0x1370, 0x00, 0x00, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_TRSV, 0x13D0, 0x13D0, 0xFF, 0xFF, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
