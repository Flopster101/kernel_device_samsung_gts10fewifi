...
static struct ufs_cal_phy_cfg init_cfg_evt0[] = {
	...
	{0x0000, 0x013C, 0x02, PMD_ALL, PHY_PCS_COMN, BRD_ALL},
	...
	{0x0000, 0x013C, 0x00, PMD_ALL, PHY_PCS_COMN, BRD_ALL},

	{0x0000, 0x013C, 0x03, PMD_ALL, PHY_PCS_RX, BRD_ALL},
	...
	{0x0000, 0x013C, 0x00, PMD_ALL, PHY_PCS_RX, BRD_ALL},
	...
	{0x0000, 0x0048, 0x00, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x021C, 0x31, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x0220, 0x08, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x0230, 0xEF, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x0274, 0x77, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x02A4, 0x03, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x031C, 0x00, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x0450, 0xA0, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x0454, 0x78, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x0838, 0x44, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x0844, 0x44, PMD_ALL, PHY_PMA_COMN, BRD_ALL},

	{0x0000, 0x0300, 0x21, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x14E4, 0x11, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1B38, 0x11, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	...
	{0x0000, 0x158C, 0x57, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	/*OTP HEDGE SFR group S*/
	{0x0000, 0x10E0, 0x0C, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x10F4, 0x14, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0, 0, 0, PMD_ALL,	PHY_PMA_OTP_HEDGE, BRD_ALL},
	...
	{0x0000, 0x1334, 0x55, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1340, 0x44, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1344, 0x03, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1354, 0x55, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1360, 0x33, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1364, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x137C, 0x55, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1380, 0x04, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1388, 0x44, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x138C, 0x01, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x139C, 0x55, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x13AC, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x13DC, 0x46, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x13E4, 0x06, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x13EC, 0x33, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x13F0, 0x05, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x13FC, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x150C, 0x01, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1B40, 0x3F, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1B4C, 0x60, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},

	{0x0000, 0x1554, 0x55, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1558, 0x44, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x155C, 0x02, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1560, 0x11, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1564, 0x44, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1568, 0x05, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1570, 0x11, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x15EC, 0x44, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1604, 0x44, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x160C, 0x11, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1610, 0x11, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1780, 0x10, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x13C8, 0x0F, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x13D0, 0x7F, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x17B8, 0x01, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1B20, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1B24, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1B50, 0x03, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1BB4, 0xE0, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1B04, 0x10, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1054, 0x02, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},

	{0x0000, 0x1800, 0x10, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x181C, 0x17, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1820, 0xA8, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1824, 0xC0, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1834, 0x01, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1978, 0x13, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1988, 0x17, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x0A00, 0x11, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x0A00, 0x00, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x1F5C, 0x01, PMD_ALL, PHY_EMB_CAL_WAIT, BRD_ALL},
	{0, 0, 0, PMD_HS_G4, PHY_PMA_OC_CODE, BRD_ALL},

	{0x0000, 0x0A00, 0x10, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x1978, 0x14, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1988, 0x06, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
...
static otp_hedge_pma_cfg pma_otp_hedge[] =
{
	/* etype, otp_Addr, otp_mask, otp_bitpos, pma_addr, pma_mask, pma_bitpos*/
	{PMA_SET_TYPE_CMN,  0xE3F5, 0x07, 0x00, 0x0278, 0x07, 0x00},
	{PMA_SET_TYPE_CMN,  0xE3F4, 0xFF, 0x00, 0x00A0, 0xFF, 0x00},
	{PMA_SET_TYPE_TRSV, 0xE3F3, 0x07, 0x00, 0x158C, 0x07, 0x00},
	{PMA_SET_TYPE_TRSV, 0xE3F2, 0x07, 0x00, 0x258C, 0x07, 0x00},
	{PMA_SET_TYPE_TRSV, 0xE3F1, 0x1F, 0x00, 0x10E0, 0x1F, 0x00},
	{PMA_SET_TYPE_TRSV, 0xE3F0, 0x1F, 0x00, 0x10F4, 0x1F, 0x00},
	{PMA_SET_TYPE_TRSV, 0xE3EF, 0x1F, 0x00, 0x20E0, 0x1F, 0x00},
	{PMA_SET_TYPE_TRSV, 0xE3EE, 0x1F, 0x00, 0x20F4, 0x1F, 0x00},
	{PMA_SET_TYPE_TRSV, 0xE3ED, 0x0F, 0x00, 0x1BC0, 0x0F, 0x00},
	{PMA_SET_TYPE_TRSV, 0xE3EC, 0x0F, 0x00, 0x2BC0, 0x0F, 0x00},
	{PMA_SET_TYPE_NONE, 0x0000, 0x00, 0x00, 0x0000, 0x00, 0x00},
};

static struct ufs_cal_phy_cfg init_cfg_evt0_overwrite[][6] = {
	{{0x0000, 0x1054, 0x02, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1144, 0x02, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1370, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x13D0, 0xFF, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x13D4, 0xFF, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0, 0, 0, 0, PHY_CFG_NONE, BRD_ALL}}
};
...
static struct ufs_cal_phy_cfg init_cfg_evt1_overwrite[][6] = {
	{{0x0000, 0x1054, 0x02, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1144, 0x02, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x1370, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x13D0, 0xFF, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},
...
static struct ufs_cal_phy_cfg backup_pma_oc_code_for_snr[] = {
	/* mib(just to monitor), sfr offset, value, .. */
	/* 0x00~0x07 : backup index(not used)
	 ...
	 */
	{0, 0x1F18, 0x00, PMD_HS, PHY_PMA_TRSV, BRD_ALL},
	{0, 0x1F1C, 0x01, PMD_HS, PHY_PMA_TRSV, BRD_ALL},
	{0, 0x1F24, 0x02, PMD_HS, PHY_PMA_TRSV, BRD_ALL},
	{0, 0x1F30, 0x03, PMD_HS, PHY_PMA_TRSV, BRD_ALL},
	{0, 0x1F20, 0x04, PMD_HS, PHY_PMA_TRSV, BRD_ALL},
	{0, 0x1F2C, 0x05, PMD_HS, PHY_PMA_TRSV, BRD_ALL},
	{0, 0x1F28, 0x06, PMD_HS, PHY_PMA_TRSV, BRD_ALL},
	{0, 0x1F34, 0x07, PMD_HS, PHY_PMA_TRSV, BRD_ALL},
...
static struct ufs_cal_phy_cfg pre_h8_exit[] = {
	...
	{0x0000, 0x000, 0x1E, PMD_ALL, COMMON_WAIT, BRD_ALL},
...
static struct ufs_cal_phy_cfg post_ah8_cfg[] = {
	...
	{0x0000, 0x1620, 0x140017, PMD_ALL, HCI_AH8_CMN, BRD_ALL},
	...
	{0x0000, 0x1790, 0x40640000, PMD_ALL, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x17D0, 0x00000000, PMD_ALL, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x1794, 0x00000A20, PMD_ALL, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x17D4, 0x00000000, PMD_ALL, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x1798, 0x401E0000, PMD_ALL, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x17D8, 0x00000000, PMD_ALL, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x179C, 0x00000000, PMD_ALL, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x17DC, 0x00000031, PMD_ALL, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x17A0, 0x00000610, PMD_ALL, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x17E0, 0x00000023, PMD_ALL, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x17A4, 0x40030000, PMD_ALL, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x17E4, 0x00000000, PMD_ALL, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x17A8, 0x00001584, PMD_ALL, HCI_AH8_TRSV, BRD_ALL},
	{0x0000, 0x17E8, 0x00000001, PMD_ALL, HCI_AH8_CMN, BRD_ALL},
	{0x0000, 0x17AC, 0x00001588, PMD_ALL, HCI_AH8_TRSV, BRD_ALL},
	{0x0000, 0x17EC, 0x00000000, PMD_ALL, HCI_AH8_CMN, BRD_ALL},
