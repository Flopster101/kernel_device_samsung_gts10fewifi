...
#define NUM_OF_UFS_MMIO_REGIONS 5
	...
	struct ext_cxt cxt_phy_pwr_off;
...
#endif
#define LEN_OF_INT_TABLE 20
	s32 pm_qos_int_value[LEN_OF_INT_TABLE];
...
#define EXYNOS_UFS_BIT_DBG_DUMP			(0)
	...
	bool skip_flush;
	u32 irq_affinity;
	u32 mcq_not_supported;

	ufs_pm_state pm_state;
