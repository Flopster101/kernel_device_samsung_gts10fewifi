...
#define CPIF_PAGE_POOL_MULT	4
#define MIN_PAGE_POOL_MULT	2
...
struct cpif_page_pool *cpif_page_pool_delete(struct cpif_page_pool *pool);
...
int cpif_page_pool_expand(struct cpif_page_pool *pool, u64 page_size);
...
int cpif_page_pool_lazy_deletion(struct cpif_page_pool *pool, u64 pool_mult);
int cpif_page_pool_continue(u64 page_size, struct cpif_page_pool *pool);
#else
static inline struct cpif_page_pool *cpif_page_pool_delete(struct cpif_page_pool *pool)
					{ return NULL; }
...
static inline void *cpif_page_alloc(struct cpif_page_pool *pool, u64 alloc_size,
				    bool *used_tmp_alloc) { return NULL; }
static inline int cpif_page_pool_expand(struct cpif_page_pool *pool, u64 page_size) { return 0; }

static inline int cpif_page_pool_lazy_deletion(struct cpif_page_pool *pool, u64 pool_mult) { return 0; }
