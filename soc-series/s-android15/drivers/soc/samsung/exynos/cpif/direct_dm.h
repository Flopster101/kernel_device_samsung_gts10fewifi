...
extern irqreturn_t direct_dm_irq_handler(int irq, void *arg);
extern struct direct_dm_ctrl *direct_dm_get_dc(void);
#else
...
static inline irqreturn_t direct_dm_irq_handler(int irq, void *arg) { return IRQ_HANDLED; }
static inline struct direct_dm_ctrl *direct_dm_get_dc(void) { return NULL; }
#endif
